...
const EventFormInfo = ({ methods, setEditValue, editValue }: Props) => {
  console.log("🚀 ~ file: EventFormInfo.tsx:17 ~ EventFormInfo ~ editValue:", editValue)
  const {
    watch,
    setValue,
  } = methods;
    ...
    <Box>
      <Card sx={{ px: 3, py: 3 }}>
        <Grid container spacing={3}>
          ...
          {/* <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
            <RHFTextField name="content" isRequired label={t('content')} />
              
          </Grid> */}
          
         <Grid item xs={12} sm={12} md={12}>
            <Typography variant="body1">{t('thumbnail')}</Typography>
            <RHFUpload
              name="thumbnail"
              maxSize={3145728}
        ...
        {/* <Grid item xs={12} sm={12} md={6} lg={6} xl={2}>
            <RHFCheckbox name="isActive" label={t('isActive')} />
          </Grid> */}
          {/*  */}
          <Grid item xs={12} sm={12} md={12}>
